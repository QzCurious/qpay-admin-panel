export default {
  ...
  online_card: "掛載銀行卡",
  offline_card: "卸載銀行卡",
  create_card_sms: "建立卡片 SMS",
  edit_card_sms: "編輯卡片 SMS",
  enable_card_sms: "啟用卡片 SMS",
  disable_card_sms: "停用卡片 SMS",
  delete_card_sms: "刪除卡片 SMS",
  ...
  card_sms_will_be_enabled: "卡片 SMS 將被啟用",
  card_sms_will_be_disabled: "卡片 SMS 將被停用",
  card_sms_will_be_deleted: "卡片 SMS 將被刪除",
  ...
  card_sms_successfully_created: "卡片 SMS 新增成功",
  card_sms_successfully_updated: "卡片 SMS 更新成功",
  card_sms_successfully_enabled: "卡片 SMS 已啟用",
  card_sms_successfully_disabled: "卡片 SMS 已停用",
  card_sms_successfully_deleted: "卡片 SMS 已刪除",
