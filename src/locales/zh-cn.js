export default {
  ...
  online_card: "挂载银行卡",
  offline_card: "卸载银行卡",
  create_card_sms: "新增银行卡短信",
  edit_card_sms: "编辑银行卡短信",
  enable_card_sms: "启用银行卡短信",
  disable_card_sms: "停用银行卡短信",
  delete_card_sms: "删除银行卡短信",
  ...
  card_sms_will_be_enabled: "银行卡短信将被启用",
  card_sms_will_be_disabled: "银行卡短信将被停用",
  card_sms_will_be_deleted: "银行卡短信将被删除",
  ...
  card_sms_successfully_created: "银行卡短信新增成功",
  card_sms_successfully_updated: "银行卡短信更新成功",
  card_sms_successfully_enabled: "银行卡短信启用成功",
  card_sms_successfully_disabled: "银行卡短信停用成功",
  card_sms_successfully_deleted: "银行卡短信删除成功",
